...
subcommands.create = utils.module(function (exports) {
  ...
  exports.help = function () {
    utils.printArray([
      ...
      '',
      '  If --ip is not specified, the next available IP after 192.168.22.10 will'.grey,
      '  be automatically assigned. User is root by default. Vagrant files are stored'.grey,
      '  in the ~/.overcast-vagrant directory. Image names "trusty64" (Ubuntu 14.04)'.grey,
      '  and "precise64" (Ubuntu 12.04) are downloaded automatically from Ubuntu'.grey,
      '  servers the first time they are used.'.grey,
      '',
      '  Other image names will need to be added using:'.grey,
      '  $ vagrant box add --name [name] [image-url]'.grey,
      '',
      '    Option                   | Default'.grey,
